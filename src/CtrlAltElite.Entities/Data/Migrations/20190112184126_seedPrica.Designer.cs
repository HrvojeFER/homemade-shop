...
namespace CtrlAltElite.Entities.Data.Migrations
{
    ...
    [Migration("20190112184126_seedPrica")]
    partial class seedPrica
    {
            ...
            modelBuilder.Entity("CtrlAltElite.Entities.Models.Prica", b =>
                {
                    ...
                    b.HasData(
                        new { IdPrica = 1, IdKorisnik = 1, IdStatus = 1, Sadrzaj = "Ova posuda je je baš kao i na stranici. Dizajn je prelijep, a isto tako mi se sviđa tekstura ukrašavanja. Ako želite dobiti komplimente od drugih prijateljica, naručite ovo za dnevnu sobu. Uvelike preporučam.", UrlSlike = "/images/bowl.jpg", VrijemeObjave = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { IdPrica = 2, IdKorisnik = 2, IdStatus = 1, Sadrzaj = "Posuda za cvijeće od gline je jako lijepa", UrlSlike = "/images/pot.png", VrijemeObjave = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                    );
                });
